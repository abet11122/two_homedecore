...
import { L as unescapeHTML, O as renderTemplate, St as generateCspDigest, b as spreadAttributes, ot as removeBase, rt as isRemotePath } from "./sequence_CyX1LPhK.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_vzYkrgzD.mjs");
...
//#endregion
export { getEntry as n, getCollection as t };
