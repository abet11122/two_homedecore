...
import { A as addAttribute, D as renderTemplate, I as unescapeHTML, O as maybeRenderHead, R as createAstro, nt as isRemotePath, rt as joinPaths, st as removeQueryString, y as spreadAttributes } from "./sequence_VRBs3N3Z.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_D4rduWVc.mjs").catch((e) => {
